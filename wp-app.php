...
/*--------------------------------------------------
 ...
 | By Fabrيcio Seger Kolling
 | Copyright (c) 2004 Fabrيcio Seger Kolling
...
function et($tag){
    ...
    $pt['SaveConfig'] = 'Salvar Configuraçُes';
    ...
    $pt['Configurations'] = 'Configuraçُes';
    $pt['JSError'] = 'Erro de JavaScript';
    $pt['NoSel'] = 'Nمo hل itens selecionados';
    $pt['SelDir'] = 'Selecione o diretَrio de destino na لrvore a esquerda';
    $pt['TypeDir'] = 'Digite o nome do diretَrio';
    $pt['TypeArq'] = 'Digite o nome do arquivo';
    $pt['TypeCmd'] = 'Digite o commando';
    $pt['TypeArqComp'] = 'Digite o nome do arquivo.\\nA extensمo determina o tipo de compactaçمo.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $pt['RemSel'] = 'APAGAR itens selecionados';
    $pt['NoDestDir'] = 'Nمo hل um diretَrio de destino selecionado';
    $pt['DestEqOrig'] = 'Diretَrio de origem e destino iguais';
    $pt['InvalidDest'] = 'Diretَrio de destino invلlido';
    $pt['NoNewPerm'] = 'Nova permissمo nمo foi setada';
    $pt['CopyTo'] = 'COPIAR para';
    $pt['MoveTo'] = 'MOVER para';
    $pt['AlterPermTo'] = 'ALTERAR PERMISSصES para';
    $pt['ConfExec'] = 'Confirma EXECUTAR';
    $pt['ConfRem'] = 'Confirma APAGAR';
    $pt['EmptyDir'] = 'Diretَrio vazio';
    $pt['IOError'] = 'Erro de E/S';
    $pt['FileMan'] = 'PHP File Manager';
    $pt['TypePass'] = 'Digite a senha';
    $pt['InvPass'] = 'Senha Invلlida';
    $pt['ReadDenied'] = 'Acesso de leitura negado';
    $pt['FileNotFound'] = 'Arquivo nمo encontrado';
    $pt['AutoClose'] = 'Fechar Automaticamente';
    $pt['OutDocRoot'] = 'Arquivo fora do DOCUMENT_ROOT';
    $pt['NoCmd'] = 'Erro: Comando nمo informado';
    $pt['ConfTrySave'] = 'Arquivo sem permissمo de escrita.\\nTentar salvar assim mesmo';
    $pt['ConfSaved'] = 'Configuraçُes salvas';
    $pt['PassSaved'] = 'Senha salva';
    $pt['FileDirExists'] = 'Arquivo ou diretَrio jل existe';
    $pt['NoPhpinfo'] = 'Funçمo phpinfo desabilitada';
    $pt['NoReturn'] = 'sem retorno';
    $pt['FileSent'] = 'Arquivo enviado';
    $pt['SpaceLimReached'] = 'Limite de espaço alcançado';
    $pt['InvExt'] = 'Extensمo invلlida';
    $pt['FileNoOverw'] = 'Arquivo nمo pode ser sobreescrito';
    $pt['FileOverw'] = 'Arquivo sobreescrito';
    $pt['FileIgnored'] = 'Arquivo omitido';
    $pt['ChkVer'] = 'Verificar sf.net por nova versمo';
    $pt['ChkVerAvailable'] = 'Nova versمo, clique aqui para iniciar download!!';
    $pt['ChkVerNotAvailable'] = 'Nمo hل nova versمo disponيvel :(';
    $pt['ChkVerError'] = 'Erro de conexمo.';
    $pt['Website'] = 'Website';
    ...
    $pt['Total'] = 'total';
    $pt['Partition'] = 'Partiçمo';
    $pt['RenderTime'] = 'Tempo para gerar esta pلgina';
    $pt['Seconds'] = 'seg';
...
function remove_acentos($str){
    $str = trim($str);
    $str = strtr($str,"¥µہءآأؤإئابةتثجحخدذرزسشصضطظعغـفكàلâمنهوçèéêëىيîïًٌٍَôُِّùْûü‎ے!@#%&*()[]{}+=?",
        ...
        while ($file = readdir($opdir)) {
          if (($file != ".")&&($file != "..")){
            if (is_file($dir_atual.$file)){
                ...
                // Funçمo filetype() returns only "file"...
...
class zip_file extends archive
{
    ...
    function create_zip()
    {
        ...
        foreach($this->files as $current)
        {
            ...
            $translate =  array('ا'=>pack("C",128),'ü'=>pack("C",129),'é'=>pack("C",130),'â'=>pack("C",131),'ن'=>pack("C",132),
                                'à'=>pack("C",133),'ه'=>pack("C",134),'ç'=>pack("C",135),'ê'=>pack("C",136),'ë'=>pack("C",137),
                                'è'=>pack("C",138),'ï'=>pack("C",139),'î'=>pack("C",140),'ى'=>pack("C",141),'ؤ'=>pack("C",142),
                                'إ'=>pack("C",143),'ة'=>pack("C",144),'و'=>pack("C",145),'ئ'=>pack("C",146),'ô'=>pack("C",147),
                                'ِ'=>pack("C",148),'ٍ'=>pack("C",149),'û'=>pack("C",150),'ù'=>pack("C",151),'_'=>pack("C",152),
                                'ض'=>pack("C",153),'ـ'=>pack("C",154),'£'=>pack("C",156),'¥'=>pack("C",157),'_'=>pack("C",158),
                                'ƒ'=>pack("C",159),'ل'=>pack("C",160),'ي'=>pack("C",161),'َ'=>pack("C",162),'ْ'=>pack("C",163),
                                'ٌ'=>pack("C",164),'ر'=>pack("C",165));
